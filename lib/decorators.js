...
function httpContextAccessDecoratorFactory(implementation) {
...
exports.httpContextAccessDecoratorFactory = httpContextAccessDecoratorFactory;
...
function isResourceOwner(resorceId, pass) {
    var _this = this;
    if (pass === void 0) { pass = true; }
    return httpContextAccessDecoratorFactory(function (context) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
